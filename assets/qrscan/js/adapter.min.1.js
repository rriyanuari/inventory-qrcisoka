    ...
    return function e(t, r, n) {
        ...
        1: [function(e, t, r) {
            ...
            n.generateIdentifier = function() {
                ...
                var r = n.splitLines(e);
                return r = r.concat(n.splitLines(t)), {
        ...
        2: [function(e, t, r) {
            ...
            ! function() {
                var r = e("./utils"),
                    n = r.log,
                    i = r.browserDetails;
                t.exports.browserDetails = i, t.exports.extractVersion = r.extractVersion, t.exports.disableLog = r.disableLog;
                ...
                switch (i.browser) {
                    case "chrome":
                        if (!a || !a.shimPeerConnection) return void n("Chrome shim is not included in this adapter release.");
                        n("adapter.js shimming chrome."), t.exports.browserShim = a, a.shimGetUserMedia(), a.shimMediaStream(), r.shimCreateObjectURL(), a.shimSourceObject(), a.shimPeerConnection(), a.shimOnTrack(), a.shimGetSendersWithDtmf();
                        break;
                    case "firefox":
                        if (!s || !s.shimPeerConnection) return void n("Firefox shim is not included in this adapter release.");
                        n("adapter.js shimming firefox."), t.exports.browserShim = s, s.shimGetUserMedia(), r.shimCreateObjectURL(), s.shimSourceObject(), s.shimPeerConnection(), s.shimOnTrack();
                        break;
                    case "edge":
                        if (!o || !o.shimPeerConnection) return void n("MS edge shim is not included in this adapter release.");
                        n("adapter.js shimming edge."), t.exports.browserShim = o, o.shimGetUserMedia(), r.shimCreateObjectURL(), o.shimPeerConnection(), o.shimReplaceTrack();
                        break;
                    case "safari":
                        if (!c) return void n("Safari shim is not included in this adapter release.");
                        n("adapter.js shimming safari."), t.exports.browserShim = c, c.shimOnAddStream(), c.shimGetUserMedia();
                        break;
                    default:
                ...
                a = {
                    ...
                    shimGetSendersWithDtmf: function() {
                        if ("object" == typeof window && window.RTCPeerConnection && !("getSenders" in RTCPeerConnection.prototype) && "createDTMFSender" in RTCPeerConnection.prototype) {
                            ...
                            RTCPeerConnection.prototype.addStream = function(t) {
                                var r = this;
                                r._senders = r._senders || [], e.apply(r, [t]), t.getTracks().forEach(function(e) {
                                    r._senders.push({
                                        track: e,
                                        get dtmf() {
                                            return void 0 === this._dtmf && ("audio" === e.kind ? this._dtmf = r.createDTMFSender(e) : this._dtmf = null), this._dtmf
                                        }
                                    })
                                })
                            }, RTCPeerConnection.prototype.removeStream = function(e) {
                                var r = this;
                                r._senders = r._senders || [], t.apply(r, [e]), e.getTracks().forEach(function(e) {
                    ...
                    shimPeerConnection: function() {
                        if (window.RTCPeerConnection) {
                            ...
                            window.RTCPeerConnection = function(t, r) {
                                if (t && t.iceServers) {
                                    for (var n = [], i = 0; i < t.iceServers.length; i++) {
                                        ...
                                        !a.hasOwnProperty("urls") && a.hasOwnProperty("url") ? (console.warn("RTCIceServer.url is deprecated! Use urls instead."), a = JSON.parse(JSON.stringify(a)), a.urls = a.url, n.push(a)) : n.push(t.iceServers[i])
                                    }
                                    t.iceServers = n
                                }
                                return new e(t, r)
                            ...
                            return n("PeerConnection"), e && e.iceTransportPolicy && (e.iceTransports = e.iceTransportPolicy), new webkitRTCPeerConnection(e, t)
                        ...
                        }), i.version < 52 && ["createOffer", "createAnswer"].forEach(function(e) {
                            var t = RTCPeerConnection.prototype[e];
                            RTCPeerConnection.prototype[e] = function() {
                                var e = this;
                ...
                var e = function(e) {
                        ...
                        return Object.keys(e).forEach(function(r) {
                            if ("require" !== r && "advanced" !== r && "mediaSource" !== r) {
                                ...
                                if (void 0 !== n.ideal) {
                                    ...
                                    var a = {};
                                    "number" == typeof n.ideal ? (a[i("min", r)] = n.ideal, t.optional.push(a), a = {}, a[i("max", r)] = n.ideal, t.optional.push(a)) : (a[i("", r)] = n.ideal, t.optional.push(a))
                                }
                    ...
                    t = function(t, r) {
                        if (t = JSON.parse(JSON.stringify(t)), t && t.audio && (t.audio = e(t.audio)), t && "object" == typeof t.video) {
                            ...
                            var o = i.version < 61;
                            if (a && ("user" === a.exact || "environment" === a.exact || "user" === a.ideal || "environment" === a.ideal) && (!navigator.mediaDevices.getSupportedConstraints || !navigator.mediaDevices.getSupportedConstraints().facingMode || o)) {
                                delete t.video.facingMode;
                                var s;
                                if ("environment" === a.exact || "environment" === a.ideal ? s = ["back", "rear"] : "user" !== a.exact && "user" !== a.ideal || (s = ["front"]), s) return navigator.mediaDevices.enumerateDevices().then(function(i) {
                                    ...
                                    return !o && i.length && -1 !== s.indexOf("back") && (o = i[i.length - 1]), o && (t.video.deviceId = a.exact ? {
                                        exact: o.deviceId
                                    } : {
                                        ideal: o.deviceId
        ...
        7: [function(e, t, r) {
                ...
                return e = JSON.parse(JSON.stringify(e)), e.filter(function(e) {
                    if (e && (e.urls || e.url)) {
                        ...
                        return i && (n = [n]), n = n.filter(function(e) {
                            return 0 !== e.indexOf("turn:") || -1 === e.indexOf("transport=udp") || -1 !== e.indexOf("turn:[") || r ? 0 === e.indexOf("stun:") && t >= 14393 : (r = !0, !0)
            ...
            t.exports = function(e) {
                var t = function(t) {
                    ...
                    this.usingBundle = t && "max-bundle" === t.bundlePolicy, t && t.iceServers && (this.iceOptions.iceServers = i(t.iceServers, e)), this._config = t || {}, this.transceivers = [], this._localIceCandidatesBuffer = []
                };
                return t.prototype._emitGatheringStateChange = function() {
                    ...
                    this._localIceCandidatesBuffer.forEach(function(r) {
                        if (r.candidate && 0 !== Object.keys(r.candidate).length) t[r.candidate.sdpMLineIndex + 1] += "a=" + r.candidate.candidate + "\r\n";
                        else
                            for (var n = 1; n < t.length; n++) - 1 === t[n].indexOf("\r\na=end-of-candidates\r\n") && (t[n] += "a=end-of-candidates\r\n");
                    ...
                    return e.codecs.forEach(function(n) {
                        for (var a = 0; a < t.codecs.length; a++) {
                            ...
                            if (n.name.toLowerCase() === o.name.toLowerCase() && n.clockRate === o.clockRate) {
                                ...
                                o = JSON.parse(JSON.stringify(o)), o.numChannels = Math.min(n.numChannels, o.numChannels), r.codecs.push(o), o.rtcpFeedback = o.rtcpFeedback.filter(function(e) {
                    ...
                    n.onlocalcandidate = function(o) {
                        ...
                        d ? void 0 === n.state && (n.state = "completed") : (c.component = "RTCP" === i.component ? 2 : 1, s.candidate.candidate = a.writeCandidate(c));
                        var p = a.splitSections(r.localDescription.sdp);
                        p[s.candidate.sdpMLineIndex + 1] += d ? "a=end-of-candidates\r\n" : "a=" + s.candidate.candidate + "\r\n", r.localDescription.sdp = p.join("");
                        ...
                        switch (r.iceGatheringState) {
                            case "new":
                                d || r._localIceCandidatesBuffer.push(s), d && f && r._localIceCandidatesBuffer.push(new Event("icecandidate"));
                                break;
                            case "gathering":
                                r._emitBufferedCandidates(), d || (r.dispatchEvent(s), null !== r.onicecandidate && r.onicecandidate(s)), f && (r.dispatchEvent(new Event("icecandidate")), null !== r.onicecandidate && r.onicecandidate(new Event("icecandidate")), r.iceGatheringState = "complete", r._emitGatheringStateChange())
                        }
                    ...
                    n && (delete n.ondtlssttatechange, delete n.onerror, delete this.transceivers[e].dtlsTransport)
                }, t.prototype._transceive = function(t, r, n) {
                    var i = this._getCommonCapabilities(t.localCapabilities, t.remoteCapabilities);
                    r && t.rtpSender && (i.encodings = t.sendEncodingParameters, i.rtcp = {
                        cname: a.localCName,
                        compound: t.rtcpParameters.compound
                    }, t.recvEncodingParameters.length && (i.rtcp.ssrc = t.recvEncodingParameters[0].ssrc), t.rtpSender.send(i)), n && t.rtpReceiver && ("video" === t.kind && t.recvEncodingParameters && e < 15019 && t.recvEncodingParameters.forEach(function(e) {
                        delete e.rtx
                    }), i.encodings = t.recvEncodingParameters, i.rtcp = {
                        cname: t.rtcpParameters.cname,
                        compound: t.rtcpParameters.compound
                    }, t.sendEncodingParameters.length && (i.rtcp.ssrc = t.sendEncodingParameters[0].ssrc), t.rtpReceiver.receive(i))
                }, t.prototype.setLocalDescription = function(e) {
                    var t, r, n = this;
                    if ("offer" === e.type) this._pendingOffer && (t = a.splitSections(e.sdp), r = t.shift(), t.forEach(function(e, t) {
                        ...
                        t = a.splitSections(n.remoteDescription.sdp), r = t.shift();
                        ...
                        t.forEach(function(e, t) {
                            ...
                            if (!a.isRejected(e) && !o.isDatachannel) {
                                ...
                                i && (l.role = "server"), n.usingBundle && 0 !== t || (c.start(s, f, i ? "controlling" : "controlled"), d.start(l));
                    ...
                    if (o) {
                        ...
                        window.setTimeout(function() {
                            s(), "new" === n.iceGatheringState && (n.iceGatheringState = "gathering", n._emitGatheringStateChange()), n._emitBufferedCandidates()
                        }, 0)
                    }
                    var c = Promise.resolve();
                    return c.then(function() {
                        o || ("new" === n.iceGatheringState && (n.iceGatheringState = "gathering", n._emitGatheringStateChange()), window.setTimeout(n._emitBufferedCandidates.bind(n), 500))
                    }), c
                    ...
                    switch (this.canTrickleIceCandidates = !!p && p.substr(14).split(" ").indexOf("trickle") >= 0, o.forEach(function(o, p) {
                        ...
                        if ("offer" !== t.type || l) "answer" !== t.type || l || (d && p > 0 && (r._disposeIceAndDtlsTransports(p), r.transceivers[p].iceGatherer = r.transceivers[0].iceGatherer, r.transceivers[p].iceTransport = r.transceivers[0].iceTransport, r.transceivers[p].dtlsTransport = r.transceivers[0].dtlsTransport, r.transceivers[p].rtpSender && r.transceivers[p].rtpSender.setTransport(r.transceivers[0].dtlsTransport), r.transceivers[p].rtpReceiver && r.transceivers[p].rtpReceiver.setTransport(r.transceivers[0].dtlsTransport)), w = r.transceivers[p], y = w.iceGatherer, C = w.iceTransport, b = w.dtlsTransport, T = w.rtpSender, P = w.rtpReceiver, S = w.sendEncodingParameters, E = w.localCapabilities, r.transceivers[p].recvEncodingParameters = R, r.transceivers[p].remoteCapabilities = D, r.transceivers[p].rtcpParameters = M, (c || L) && j.length && C.setRemoteCandidates(j), d && 0 !== p || (C.start(y, x, "controlling"), b.start(O)), r._transceive(w, "sendrecv" === h || "recvonly" === h, "sendrecv" === h || "sendonly" === h), !P || "sendrecv" !== h && "sendonly" !== h ? delete w.rtpReceiver : (k = P.track, v ? (n[v.stream] || (n[v.stream] = new MediaStream), n[v.stream].addTrack(k), i.push([k, P, n[v.stream]])) : (n.default || (n.default = new MediaStream), n.default.addTrack(k), i.push([k, P, n.default]))));
                            ...
                            if (!L || d && 0 !== p || _.iceTransport.setRemoteCandidates(j), E = RTCRtpReceiver.getCapabilities(f), e < 15019 && (E.codecs = E.codecs.filter(function(e) {
                                    return "rtx" !== e.name
                                })), S = [{
                                    ssrc: 1001 * (2 * p + 2)
                                }], "sendrecv" !== h && "sendonly" !== h || (P = new RTCRtpReceiver(_.dtlsTransport, f), k = P.track, v ? (n[v.stream] || (n[v.stream] = new MediaStream, Object.defineProperty(n[v.stream], "id", {
                                    get: function() {
                                        return v.stream
                                    }
                                ...
                                }), n[v.stream].addTrack(k), i.push([k, P, n[v.stream]])) : (n.default || (n.default = new MediaStream), n.default.addTrack(k), i.push([k, P, n.default]))), r.localStreams.length > 0 && r.localStreams[0].getTracks().length >= p) {
                                var U;
                                "audio" === f ? U = r.localStreams[0].getAudioTracks()[0] : "video" === f && (U = r.localStreams[0].getVideoTracks()[0]), U && (e >= 15019 && "video" === f && (S[0].rtx = {
                                    ssrc: 1001 * (2 * p + 2) + 1
                            ...
                            }, r._transceive(r.transceivers[p], !1, "sendrecv" === h || "sendonly" === h)
                        }
                    }), this.usingBundle = d, this.remoteDescription = {
                        type: t.type,
                        sdp: t.sdp
                    }, t.type) {
                        case "offer":
                    ...
                    return Object.keys(n).forEach(function(e) {
                        ...
                        if (t.getTracks().length) {
                            ...
                            a.stream = t, r.dispatchEvent(a), null !== r.onaddstream && window.setTimeout(function() {
                                r.onaddstream(a)
                                ...
                                if (t.id === e[2].id) {
                                    ...
                                    a.track = n, a.receiver = i, a.streams = [t], r.dispatchEvent(a), null !== r.ontrack && window.setTimeout(function() {
                                        r.ontrack(a)
                                    }, 0)
                                }
                            })
                    ...
                    var r;
                    1 === arguments.length && "function" != typeof arguments[0] ? r = arguments[0] : 3 === arguments.length && (r = arguments[2]);
                    var i = [],
                        o = 0,
                        s = 0;
                    if (this.localStreams.length && (o = this.localStreams.reduce(function(e, t) {
                        ...
                        void 0 !== r.offerToReceiveAudio && (o = !0 === r.offerToReceiveAudio ? 1 : !1 === r.offerToReceiveAudio ? 0 : r.offerToReceiveAudio), void 0 !== r.offerToReceiveVideo && (s = !0 === r.offerToReceiveVideo ? 1 : !1 === r.offerToReceiveVideo ? 0 : r.offerToReceiveVideo)
                    }
                    ...
                    i.forEach(function(r, n) {
                        ...
                        e < 15019 && (p.codecs = p.codecs.filter(function(e) {
                            return "rtx" !== e.name
                        ...
                        i && (e >= 15019 && "video" === o && (l[0].rtx = {
                            ssrc: 1001 * (2 * n + 1) + 1
                        }), u = new RTCRtpSender(i, c.dtlsTransport)), r.wantReceive && (f = new RTCRtpReceiver(c.dtlsTransport, o)), d[n] = {
                        ...
                        var r = d[t];
                        c += a.writeMediaSection(r, r.localCapabilities, "offer", e.stream), c += "a=rtcp-rsize\r\n"
                    }), this._pendingOffer = d;
                    var p = new RTCSessionDescription({
                        type: "offer",
                        sdp: c
                    });
                    return arguments.length && "function" == typeof arguments[0] && window.setTimeout(arguments[0], 0, p), Promise.resolve(p)
                    ...
                    this.usingBundle && (t += "a=group:BUNDLE " + this.transceivers.map(function(e) {
                        ...
                        }).length && r.sendEncodingParameters[0].rtx && delete r.sendEncodingParameters[0].rtx, t += a.writeMediaSection(r, n, "answer", e.localStreams[0]), r.rtcpParameters && r.rtcpParameters.reducedSize && (t += "a=rtcp-rsize\r\n")
                    });
                    ...
                    if (e) {
                        ...
                        if (n) {
                            var i = Object.keys(e.candidate).length > 0 ? a.parseCandidate(e.candidate) : {};
                        ...
                        for (var s = 0; s < this.transceivers.length; s++)
                            if (this.transceivers[s].iceTransport.addRemoteCandidate({}), this.usingBundle) return Promise.resolve();
                        ...
                        if ("object" == typeof window && (window.RTCPeerConnection || window.mozRTCPeerConnection)) {
                                    ...
                                    for (var r = [], i = 0; i < e.iceServers.length; i++) {
                                        ...
                                        if (a.hasOwnProperty("urls"))
                                            for (var o = 0; o < a.urls.length; o++) {
                                                ...
                                                0 === a.urls[o].indexOf("turn") && (s.username = a.username, s.credential = a.credential), r.push(s)
                            ...
                            RTCPeerConnection.prototype.getStats = function(e, a, o) {
                                return i.apply(this, [e || null]).then(function(e) {
                                    if (n.version < 48 && (e = t(e)), n.version < 53 && !a) try {
                                        e.forEach(function(e) {
            ...
            t.exports = function() {
                var e = function(e) {
                    ...
                    t = function(t, r, a) {
                        ...
                        return t = JSON.parse(JSON.stringify(t)), i.version < 38 && (n("spec: " + JSON.stringify(t)), t.audio && (t.audio = o(t.audio)), t.video && (t.video = o(t.video)), n("ff37: " + JSON.stringify(t))), navigator.mozGetUserMedia(t, r, function(t) {
                            a(e(t))
                        })
                    },
                    r = function(e) {
                ...
                navigator.getUserMedia = function(e, r, n) {
                    ...
                    console.warn("navigator.getUserMedia has been replaced by navigator.mediaDevices.getUserMedia"), navigator.mediaDevices.getUserMedia(e).then(r, n)
                }
            }
        }, {
            "../utils": 11
        ...
        10: [function(e, t, r) {
            ...
            var n = {
                ...
                shimGetUserMedia: function() {
                    navigator.getUserMedia || (navigator.webkitGetUserMedia ? navigator.getUserMedia = navigator.webkitGetUserMedia.bind(navigator) : navigator.mediaDevices && navigator.mediaDevices.getUserMedia && (navigator.getUserMedia = function(e, t, r) {
            ...
            var n = !0,
                i = {
                    ...
                    detectBrowser: function() {
                        ...
                        if (navigator.mozGetUserMedia) e.browser = "firefox", e.version = this.extractVersion(navigator.userAgent, /Firefox\/(\d+)\./, 1);
                        else if (navigator.webkitGetUserMedia)
                            if (window.webkitRTCPeerConnection) e.browser = "chrome", e.version = this.extractVersion(navigator.userAgent, /Chrom(e|ium)\/(\d+)\./, 2);
                            else {
                        ...
                        else if (navigator.mediaDevices && navigator.userAgent.match(/Edge\/(\d+).(\d+)$/)) e.browser = "edge", e.version = this.extractVersion(navigator.userAgent, /Edge\/(\d+).(\d+)$/, 2);
                        else {
                    ...
                    shimCreateObjectURL: function() {
                        if ("object" == typeof window && window.HTMLMediaElement && "srcObject" in window.HTMLMediaElement.prototype) {
                            ...
                            URL.createObjectURL = function(t) {
                                if ("getTracks" in t) {
                                    var i = "polyblob:" + ++n;
                                    return r.set(i, t), console.log("URL.createObjectURL(stream) is deprecated! Use elem.srcObject = stream instead!"), i
                                }
                                return e(t)
                            }, URL.revokeObjectURL = function(e) {
                                t(e), r.delete(e)
                            };
                            var i = Object.getOwnPropertyDescriptor(window.HTMLMediaElement.prototype, "src");
                            Object.defineProperty(window.HTMLMediaElement.prototype, "src", {
                                get: function() {
                                    return i.get.apply(this)
                                },
                                set: function(e) {
                                    return this.srcObject = r.get(e) || null, i.set.apply(this, [e])
                                }
                            });
